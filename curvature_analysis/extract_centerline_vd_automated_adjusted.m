...
%     corr_data_average = -ones(numcurvpts, 3);
    ...
    if j == istart
        ...
        text(10, 20, filename, 'Color', 'white', 'Interpreter', 'none');
        text(10, 40, 'Click on head', 'Color', 'white');
        [headx, heady] = ginput(1);
        hold on; plot(headx, heady, 'og');
%         headx0 = headx; heady0 = heady;

        text(10, 60, 'Click on tail', 'Color', 'white');
...
%         bkg_c=mean(mean(c(cropy1_bkg:cropy2_bkg,cropx1_bkg:cropx2_bkg))); 
        ...
        text(10, 80, 'Click on ventral side', 'Color', 'white');     
