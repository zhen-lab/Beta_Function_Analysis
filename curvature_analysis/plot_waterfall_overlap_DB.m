function [] = plot_waterfall_overlap_DB(ratio, curv, colornum)
...
if size(ratio)==size(curv)
    ...
    title('\color{red}Activity \color{black}and \color{red}Curvature \color{black}of B motoneurons in forward movement');
