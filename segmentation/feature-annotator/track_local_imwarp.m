...
%         try
            ...
            if ~isempty(reference_features)
                ...
                % Lookup answer based on previously registered frames.
                    ...
                    % Take the average displacement of the two nearest good
                    % references (can be param later)
                    displacements = good_ref_coords(:,2) - source(:,2);
