function [maxima, vals] = local_maxima(x, K, varargin)
...
%
% maxima = local_maxima(x, K, 'filter', @feature_annotator_filter)
%
%   Process x using a custom filter prior to finding a maximum.
%
