function varargout = feature_annotator_callbacks(what,varargin)
...
function Update_Image
    ...
    if ~isfield(feature_annotator_data, 'size_T')
        feature_annotator_data.size_T = ...
            get_size_T(feature_annotator_data.image_location);
    end
    ...
    feature_annotator_data.t = max(feature_annotator_data.t, 1);
    feature_annotator_data.t = min(feature_annotator_data.t, ...
        feature_annotator_data.size_T);

    if ~isfield(feature_annotator_data, 'size_Z')
        feature_annotator_data.size_Z = ...
            size(feature_annotator_data.image_location, 3);
    end

    if ~isfield(feature_annotator_data, 'z')
        feature_annotator_data.z = round(feature_annotator_data.size_Z/2);
    end
