function write_mamut_xml(tracks, outputDirectory, stackRes)
...
% imageFilename:  name of the data xml file
% stackRes:       pixel size of [x, y, z]


[p,d,e] = fileparts(outputDirectory);
...
[pathstr,name,ext] = fileparts(referenceFilename);
