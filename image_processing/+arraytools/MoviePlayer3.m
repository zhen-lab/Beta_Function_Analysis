classdef MoviePlayer3 < hgsetget
    ...
    methods
        ...
        function obj = MoviePlayer3(x)
            ...
            DataX = CachedArray(LambdaArray(MatfileArray(x, 'images'), ...
                @max_intensity_x_side_camera_single));
            DataY = CachedArray(LambdaArray(MatfileArray(x, 'images'), ...
                @max_intensity_y_side_camera_single));
            DataZ = CachedArray(LambdaArray(MatfileArray(x, 'images'), ...
                @max_intensity_z_side_camera_single));
